...
import monte_carlo.src.main.java.com.monte_carlo.App;
...
public class AppTest {
    ...
    public void testCalculatePriceProbabilities() {
        ...
        Map<Integer, Double> priceProbabilities = App.calculatePriceProbabilities(finalPrices);
    ...
    public void testSimulateSharePrice1() {
        ...
        int numSteps = 1;
        int numWalks = 1;
        List<Integer> finalPrices = App.simulateSharePrice(numSteps, numWalks);
    ...
    public void testProbabilityDistributionSumsToOne() {
        ...
        List<Integer> finalPrices = App.simulateSharePrice(numSteps, numWalks);
        Map<Integer, Double> probabilityTable = App.calculatePriceProbabilities(finalPrices);
    ...
    public void testCalculatePriceProbabilitiesExecutionTime() {
        ...
        List<Integer> finalPrices = App.simulateSharePrice(numSteps, numWalks);
        Map<Integer, Double> priceProbabilities = App.calculatePriceProbabilities(finalPrices);
        App.displayPriceProbabilities(priceProbabilities);
